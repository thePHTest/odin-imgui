...
font_atlas_get_mouse_cursor_tex_data                  :: #force_inline proc(self: ^Font_Atlas, cursor: Mouse_Cursor, out_offset: ^Vec2, out_size: ^Vec2, out_uv_border: [^]Vec2, out_uv_fill: [^]Vec2) -> bool                     { return ImFontAtlas_GetMouseCursorTexData(self, cursor, out_offset, out_size, out_uv_border, out_uv_fill)}

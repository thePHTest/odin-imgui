...
draw_cmd_get_tex_id :: #force_inline proc(self: ^Draw_Cmd) -> Texture_ID do return ImDrawCmd_GetTexID(self);
...
draw_list_try_merge_draw_cmds            :: #force_inline proc(self: ^Draw_List)                                                                                                                                         do ImDrawList__TryMergeDrawCmds(self);
...
io_add_focus_event           :: #force_inline proc(self: ^IO, focused: bool)                                                                 do ImGuiIO_AddFocusEvent(self, focused);
...
io_add_key_analog_event      :: #force_inline proc(self: ^IO, key: Key, down: bool, v: f32)                                                  do ImGuiIO_AddKeyAnalogEvent(self, key, down, v);
io_add_key_event             :: #force_inline proc(self: ^IO, key: Key, down: bool)                                                          do ImGuiIO_AddKeyEvent(self, key, down);
io_add_mouse_button_event    :: #force_inline proc(self: ^IO, button: i32, down: bool)                                                       do ImGuiIO_AddMouseButtonEvent(self, button, down);
io_add_mouse_pos_event       :: #force_inline proc(self: ^IO, x: f32, y: f32)                                                                do ImGuiIO_AddMousePosEvent(self, x, y);
io_add_mouse_viewport_event  :: #force_inline proc(self: ^IO, id: ImID)                                                                      do ImGuiIO_AddMouseViewportEvent(self, id);
io_add_mouse_wheel_event     :: #force_inline proc(self: ^IO, wh_x: f32, wh_y: f32)                                                          do ImGuiIO_AddMouseWheelEvent(self, wh_x, wh_y);
io_clear_input_characters    :: #force_inline proc(self: ^IO)                                                                                do ImGuiIO_ClearInputCharacters(self);
io_clear_input_keys          :: #force_inline proc(self: ^IO)                                                                                do ImGuiIO_ClearInputKeys(self);
io_set_key_event_native_data :: #force_inline proc(self: ^IO, key: Key, native_keycode: i32, native_scancode: i32, native_legacy_index := i32(-1)) do ImGuiIO_SetKeyEventNativeData(self, key, native_keycode, native_scancode, native_legacy_index);
...
list_clipper_force_display_range_by_indices :: #force_inline proc(self: ^List_Clipper, item_min: i32, item_max: i32)        do ImGuiListClipper_ForceDisplayRangeByIndices(self, item_min, item_max);
...
begin_disabled                         :: #force_inline proc(disabled := bool(true))                                                                                                                                                do igBeginDisabled(disabled);
...
destroy_platform_windows               :: #force_inline proc()                                                                                                                                                                      do igDestroyPlatformWindows();
dock_space                             :: #force_inline proc(id: ImID, size := Vec2(Vec2 {0,0}), flags := Dock_Node_Flags(0), window_class : ^Window_Class = nil) -> ImID                                                           do return igDockSpace(id, size, flags, window_class);
dock_space_over_viewport               :: #force_inline proc(viewport : ^Viewport = nil, flags := Dock_Node_Flags(0), window_class : ^Window_Class = nil) -> ImID                                                                   do return igDockSpaceOverViewport(viewport, flags, window_class);
...
end_disabled                           :: #force_inline proc()                                                                                                                                                                      do igEndDisabled();
...
find_viewport_by_id                    :: #force_inline proc(id: ImID) -> ^Viewport                                                                                                                                                 do return igFindViewportByID(id);
find_viewport_by_platform_handle       :: #force_inline proc(platform_handle: rawptr) -> ^Viewport                                                                                                                                  do return igFindViewportByPlatformHandle(platform_handle);
...
get_background_draw_list_viewport_ptr  :: #force_inline proc(viewport: ^Viewport) -> ^Draw_List                                                                                                                                     do return igGetBackgroundDrawList_ViewportPtr(viewport);
...
get_foreground_draw_list_viewport_ptr  :: #force_inline proc(viewport: ^Viewport) -> ^Draw_List                                                                                                                                     do return igGetForegroundDrawList_ViewportPtr(viewport);
...
get_key_index                          :: #force_inline proc(key: Key) -> i32                                                                                                                                                       do return igGetKeyIndex(key);
get_key_name                           :: #force_inline proc(key: Key) -> cstring                                                                                                                                                   do return igGetKeyName(key);
get_key_pressed_amount                 :: #force_inline proc(key: Key, repeat_delay: f32, rate: f32) -> i32                                                                                                                         do return igGetKeyPressedAmount(key, repeat_delay, rate);
get_main_viewport                      :: #force_inline proc() -> ^Viewport                                                                                                                                                         do return igGetMainViewport();
get_mouse_clicked_count                :: #force_inline proc(button: Mouse_Button) -> i32                                                                                                                                           do return igGetMouseClickedCount(button);
...
get_platform_io                        :: #force_inline proc() -> ^Platform_Io                                                                                                                                                      do return igGetPlatformIO();
...
get_window_dock_id                     :: #force_inline proc() -> ImID                                                                                                                                                              do return igGetWindowDockID();
get_window_dpi_scale                   :: #force_inline proc() -> f32                                                                                                                                                               do return igGetWindowDpiScale();
...
get_window_viewport                    :: #force_inline proc() -> ^Viewport                                                                                                                                                         do return igGetWindowViewport();
...
is_key_down                            :: #force_inline proc(key: Key) -> bool                                                                                                                                                      do return igIsKeyDown(key);
is_key_pressed                         :: #force_inline proc(key: Key, repeat := bool(true)) -> bool                                                                                                                                do return igIsKeyPressed(key, repeat);
is_key_released                        :: #force_inline proc(key: Key) -> bool                                                                                                                                                      do return igIsKeyReleased(key);
...
is_window_docked                       :: #force_inline proc() -> bool                                                                                                                                                              do return igIsWindowDocked();
...
open_popup_str                         :: #force_inline proc(str_id: string, popup_flags := Popup_Flags(0))                                                                                                                         do swr_igOpenPopup_Str(str_id, popup_flags);
open_popup_id                          :: #force_inline proc(id: ImID, popup_flags := Popup_Flags(0))                                                                                                                               do igOpenPopup_ID(id, popup_flags);
...
render_platform_windows_default        :: #force_inline proc(platform_render_arg : rawptr = nil, renderer_render_arg : rawptr = nil)                                                                                                do igRenderPlatformWindowsDefault(platform_render_arg, renderer_render_arg);
...
set_next_window_class                  :: #force_inline proc(window_class: ^Window_Class)                                                                                                                                           do igSetNextWindowClass(window_class);
...
set_next_window_dock_id                :: #force_inline proc(dock_id: ImID, cond := Cond(0))                                                                                                                                        do igSetNextWindowDockID(dock_id, cond);
...
set_next_window_viewport               :: #force_inline proc(viewport_id: ImID)                                                                                                                                                     do igSetNextWindowViewport(viewport_id);
...
show_stack_tool_window                 :: #force_inline proc(p_open : ^bool = nil)                                                                                                                                                  do igShowStackToolWindow(p_open);
...
table_set_column_enabled               :: #force_inline proc(column_n: i32, v: bool)                                                                                                                                                do igTableSetColumnEnabled(column_n, v);
...
update_platform_windows                :: #force_inline proc()                                                                                                                                                                      do igUpdatePlatformWindows();
